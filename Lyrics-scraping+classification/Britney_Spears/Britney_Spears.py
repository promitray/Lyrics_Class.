...
songs_html = urllib2.urlopen('https://www.lyrics.com/artist/Britney+Spears/320976')
...
for url in url:
    ...
    with open('Britney-Spears_{}.txt'.format(index), 'w') as output:
          output.write(lyrics)
    with open('song_all_Britney-Spears.txt'.format(index), 'a') as output_new:
