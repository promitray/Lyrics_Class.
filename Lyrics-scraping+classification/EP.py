...
songs_html = urllib2.urlopen('https://www.lyrics.com/artist/Elvis+Presley/5175')
...
for url in url:
    ...
    with open('Elvis-Presley_{}.txt'.format(index), 'w') as output:
          output.write(lyrics)
    with open('song_all_Elvis-Presley.txt'.format(index), 'a') as output_new:
