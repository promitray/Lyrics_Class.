...
songs_html = urllib2.urlopen('https://www.lyrics.com/artist/The+Beatles/3644')
...
for url in url:
    ...
    with open('Beatles_{}.txt'.format(index), 'w') as output:
          output.write(lyrics)
    #with open('song_all_Beatles.txt'.format(index), 'a') as output_new:
